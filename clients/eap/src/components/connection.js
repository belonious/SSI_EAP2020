			...
			<div>
				<div className="col s12 m4">
					<div className="icon-block">
						...
						<a className="waves-effect waves-light btn light-blue" onClick={this.createInvitation}>invite</a>
					</div>
					<div>
				...
				<div className="col s12 m4">
					<div className="icon-block">
						...
						<a className="waves-effect waves-light btn green" id="acceptInvitation" onClick={this.acceptInvitation}>accept</a>
					</div>
				</div>
				<div className="col s12 m4">
					<div className="icon-block">
